...
## Tools for the hands-on exercise
...
Not sure which to use? See [Choosing a route](routes.md).
...
!!! warning "Shared demo account"
    ...
    **[Route B — DOME Copilot](chapters/chapter_07_route_copilot.md)**.
